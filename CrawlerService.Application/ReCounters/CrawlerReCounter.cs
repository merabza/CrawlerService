...
using CrawlerService.Application.Crawling.ToolActions;
...
namespace CrawlerService.Application.ReCounters;
...
public sealed class CrawlerReCounter : ReCounter, ICrawlProgressReporter
{
    ...
    //ICrawlProgressReporter — BatchPartRunner-ის ციკლიდან პროგრესის გადმოცემა ReCounter-ის მექანიზმზე.
